    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        ...
        const response = await axios.put(
          `${process.env.NEXT_PUBLIC_BASE_URL}/company/edit-employee/${companyId}/${employeeId}`,
          {
    ...
    const fetchEmployeeDetails = async () => {
      try {
        ...
        const response = await axios.get(
          `${process.env.NEXT_PUBLIC_BASE_URL}/company/get-single-employee/${companyId}/${employeeId}`,{
