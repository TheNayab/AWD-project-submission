    ...
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      try {
        ...
        const response = await axios.post(
          `${process.env.NEXT_PUBLIC_BASE_URL}/company/add-customer`,
    ...
    <div className="px-6 pt-5 pb-3">
      ...
      <form onSubmit={formik.handleSubmit} className="bg-white p-4 rounded-xl my-2 h-screen">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {/* Name */}
          <div>
            <label htmlFor="name" className="add_employee_labels">
              Name
            </label>
            <input
              type="text"
          ...
          {/* Email */}
          <div>
            <label htmlFor="email" className="add_employee_labels">
              Email
            </label>
            <input
              type="email"
          ...
          {/* Phone */}
          <div>
            <label htmlFor="phone" className="add_employee_labels">
              Phone
            </label>
            <input
              type="tel"
          ...
          {/* Username */}
          <div>
            <label htmlFor="user_name" className="add_employee_labels">
              User Name
            </label>
            <input
              type="text"
          ...
          {/* Set Password */}
          <div>
            <label htmlFor="password" className="add_employee_labels">
              Set Password
            </label>
            <input
              type="password"
          ...
          {/* Confirm Password */}
          <div>
            <label htmlFor="confirmPassword" className="add_employee_labels">
              Confirm Password
            </label>
            <input
              type="password"
